 ...
 */
- (void)UHFRFIDScannerResponseSuccess:(NSString *)scannerResponse withType:(NSString *)type withScanType: (NSString *)scanType{
  if ([type isEqualToString:SCANNED_VALUE]) {
    [self sendScannedTextByEvent:scannerResponse withDeviceName:@"" withType:SCANNED_VALUE withScanType: scanType];
  }else if ([type isEqualToString:DEVICE_BATTERY_STATUS]){
    [self sendScannedTextByEvent:scannerResponse withDeviceName:@"" withType:DEVICE_BATTERY_STATUS withScanType:@""];
  }
}
 ...
 */
- (void)sendScannedTextByEvent:(NSString *) Value withDeviceName: (NSString *) DeviceName withType: (NSString *) Type withScanType: (NSString *)scanType  {
  if ([strScanType isEqualToString:SCAN_TYPE_PRODUCT]) {
    [self sendEventWithName:@"UHFRFIDProductScannedValue" body:@{
                                                                 @"response": Value,
                                                                 @"type": Type,
