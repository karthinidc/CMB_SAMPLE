...
RCT_EXPORT_METHOD(startScoketScan:(NSString * ) socketScanType) {
  ...
  NSString *strDeveloperId  = ([strBundleIdentifier isEqualToString: ARAMARK_QA_BUNDLE_ID]) ? SOCKET_SCANNER_QA_DEVELOPER_ID : SOCKET_SCANNER_PROD_DEVELOPER_ID;
  appInfo.DeveloperID = strDeveloperId;
  NSString *strAppkey =  ([strBundleIdentifier isEqualToString: ARAMARK_QA_BUNDLE_ID]) ? SOCKET_SCANNER_QA_APP_KEY : SOCKET_SCANNER_PROD_APP_KEY;
