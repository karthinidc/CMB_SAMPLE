...
export default class SearchEmployeeListCell extends Component {
    static propTypes = {
  ...
  /**
    ...
    */
    ...
    render(){
      return(
        this._renderSearchEmployeeList()
      );
    }
...
let styles = StyleSheet.create({
  ...
  rowText: {
    ...
    fontWeight: '100',
    fontFamily: FONT_FAMILY.HELVETICA_CONDENSEDBLACK,
    color: COLOR.BLACK,
  },
